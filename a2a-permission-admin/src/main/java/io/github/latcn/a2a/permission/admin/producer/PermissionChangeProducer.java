...
public class PermissionChangeProducer {
    ...
    public PermissionChangeProducer(RocketMQTemplate rocketMQTemplate, ObjectMapper objectMapper) {
        this.rocketMQTemplate = rocketMQTemplate;
        this.objectMapper = objectMapper;
    }

    public void sendPermissionChange(PermissionChangeMessage message) {
        try {
