...
public class RowRuleMerger {
    ...
    public Map<String, String> merge(RoleDO role, List<RolePermissionDO> rolePermissions, List<PermissionDO> permissions) {
        Map<Long, PermissionDO> permMap = permissions.stream()
        ...
        for (RolePermissionDO rp : rolePermissions) {
            PermissionDO perm = permMap.get(rp.getPermissionId());
