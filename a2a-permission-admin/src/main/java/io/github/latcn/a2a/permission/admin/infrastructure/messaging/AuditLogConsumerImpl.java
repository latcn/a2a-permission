...
public class AuditLogConsumerImpl implements RocketMQListener<String> {

    private final AuditLogRepository auditLogRepository;
    private final ObjectMapper objectMapper;

    public AuditLogConsumerImpl(AuditLogRepository auditLogRepository, ObjectMapper objectMapper) {
